...
// What „Zapisz kolejność" writes: one section's rows renumbered 0…n-1 in the grid's current sort
...
// „Zapisz kolejność": the same write over every section at once, so one command
