...
- [ ] 1.1 New condition predicates covered in `row-conditions.test.ts` (zero-value rabat, blank komentarz, per-plane rate source)
- [ ] 1.2 Complementarity holds for every new pair
